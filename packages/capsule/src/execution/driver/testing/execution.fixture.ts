...
export function driverSandbox(
  environment: Readonly<Record<string, string>> = {},
): SandboxHandle {
  const testcontainer = Object.freeze({
    id: 'api-container', name: 'api-1', host: '127.0.0.1', labels: Object.freeze({}),
  ...
  return {
    ...
    inspectResources: unused, execute: unused, startContainerExecution: unused,
...
export function driverInput(
  ...
  return {
    projectDirectory, sessionId: 'quiet-river-ada', activityId: 'activity-1',
